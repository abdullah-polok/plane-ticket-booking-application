...
class TicketBook {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("-----+-----+-----");
        System.out.println("");
        //3. we are making a switch statement in order to go through the options according to the users choice
         switch(choiceNumber){
...
public static void flightClasses(){
    ...
    if(theClass == 'a'){
        System.out.println("the total price with additional roundtrip is " + (economyClass+roundTrip) + " IQD");
    }
    else if(theClass == 'b'){
        System.out.println("the total price with additional roundtrip is " + (businessClass+roundTrip) + " IQD");
    }
    else if(theClass == 'c'){
        System.out.println("the total price with additional roundtrip is " + (firstClass+roundTrip) + " IQD");
    }

    //if the user tries to write any letter other than the valid ones he/she will get an error
    else{
